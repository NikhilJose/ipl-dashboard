package com.nikhil.ipldashboard.data;
...
public class MatchInput {
    ...
    public void setPlayer_of_match(final String player_of_match) {
    ...
    public void setNeutral_venue(final String neutral_venue) {
    ...
    public void setResult_margin(final String result_margin) {
    ...
    public void setEliminator(final String eliminator) {
